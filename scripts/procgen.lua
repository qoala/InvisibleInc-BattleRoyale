...
function analyzeExitDistance(cxt)
    ...
    local originRoom = array.findIf(
            cxt.rooms, function(r)
                return r.tags ~= nil and
                               (r.tags.exit or r.tags.exit_vault or r.tags.exit_mid_1 or
                                       r.tags.entry_mid_2 or r.tags.exit_final)
            end)
