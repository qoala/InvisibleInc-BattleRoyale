...
function cellrig:backstab_refreshOverlay()
    ...
    if rawcell ~= nil then
        ...
        self._boardRig._backstab_overlayGrid:getGrid():setTileFlags(
                x, y, show and MOAIGridSpace.TILE_Y_FLIP or MOAIGridSpace.TILE_HIDE)
        self._boardRig._backstab_overlayGrid:getGrid():setTile(x + 1, y, idxSE)
        self._boardRig._backstab_overlayGrid:getGrid():setTileFlags(
                x + 1, y, show and MOAIGridSpace.TILE_XY_FLIP or MOAIGridSpace.TILE_HIDE)
        self._boardRig._backstab_overlayGrid:getGrid():setTile(x, y + 1, idxNW)
        self._boardRig._backstab_overlayGrid:getGrid():setTileFlags(
                x, y + 1, show and 0 or MOAIGridSpace.TILE_HIDE)
        self._boardRig._backstab_overlayGrid:getGrid():setTile(x + 1, y + 1, idxNE)
        self._boardRig._backstab_overlayGrid:getGrid():setTileFlags(
                x + 1, y + 1, show and MOAIGridSpace.TILE_X_FLIP or MOAIGridSpace.TILE_HIDE)
    end
end
